var app = angular.module('appHome',['ngAnimate', 'ngTouch', 'ui.grid.selection', 'ui.grid.exporter', 'ui.grid', 'ui.grid.pagination', 'ui.grid.cellNav', 'ui.grid.expandable',
	 ...
	 'ui.grid.infiniteScroll', 'ui.grid.importer', 'ui.grid.grouping','ui.materialize', 'toastr', 'ngResource', 'ngRoute', 'ngTouch']); 
app.pathRest = 'rest';
app.config(function($routeProvider, $locationProvider){
   ...
   .when('#!/home', {	
    ...
    .when('/cdsGridProdutos', {
	    templateUrl: './cdsProdutos/cdsGridProdutos.html',
	    controller: 'CdsGridProdutosCrtl',
   }) 
   .when('/logout', {
	   templateUrl: '../../../../',
